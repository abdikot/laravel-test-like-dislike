                    ...
                    <tbody>
                        ...
                        <tr id="product-{{ $product->id }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <i class="fa-regular fa-thumbs-up"></i> {{$product->likes_count}}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <i class="fa-regular fa-thumbs-down"></i> {{$product->dislikes_count}}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="#" class="text-blue-500 hover:underline editProduct" data-id="{{ $product->id }}">Edit</a>
                                <form action="{{ route('products.destroy', $product->id) }}" method="POST" class="inline deleteProductForm" data-id="{{ $product->id }}">
                                    @csrf
                                    @method('DELETE')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '.deleteProductForm', function(e) {
                ...
                let confirmDelete = confirm(`Apakah Anda yakin ingin menghapus Product ${productName}?`);
